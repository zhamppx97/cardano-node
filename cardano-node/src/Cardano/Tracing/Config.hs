...
type DebugPeerSelection = ("DebugPeerSelection" :: Symbol)
...
data TraceSelection
  ...
  , traceDebugPeerSelection :: OnOff DebugPeerSelection
...
traceConfigParser v =
  ...
  let acceptPolicy :: OnOff TraceAcceptPolicy
      ...
      debugPeerSelection :: OnOff DebugPeerSelection
      debugPeerSelection = OnOff False
  ...
  TracingOn <$> (TraceSelection
    ...
    <*> v .:? getName debugPeerSelection .!= debugPeerSelection
